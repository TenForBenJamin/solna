...
public class wordProx extends parama {
    ...
    public static String southendReplacement(String clubName){
        ...
        hm.put("Unión Comercio","Rioja");
        hm.put("Racing Club","Buenos Aires");
        hm.put("Defensa y Justicia","Buenos Aires");
        hm.put("Lebanon","Beirut");
        hm.put("Estudiantes FC","Merida,VE");
        hm.put("Onze Créateurs ","Bamako");
        hm.put("FK Kauno Zalgiris","Zalgiris");
        hm.put("Djurgårdens U21","Stockholm");
        hm.put("Hammarby Talang","Stockholm");
        hm.put("Saudi Arabia U17","Saudi Arabia");
        hm.put("St Louis City 2","St Louis");
        hm.put("9 de Octubre","Guayaquil");
        hm.put("CD Palestino","Santiago");
        hm.put("Czech Rep U21","Prague");
        hm.put("St Kitts & Nevis","Basseterre");
        hm.put("China","Beijing");
        hm.put("China U17","Beijing");
        hm.put("France U21","Paris");
        hm.put("China U20","Beijing");
        hm.put("China U23","Beijing");
        hm.put("Faroe Islands","Torshavn,");
        hm.put("Mallbackens IF (W)","Lysvik");
        ...
        hm.put("Security Forces Utd","Basseterre");
        hm.put("Costa Rica (W) U16","Costa Rica");
        hm.put("Costa Rica","Costa Rica");
        ...
        hm.put("Scotland (W) U17","Scotland,GB");
        hm.put("Brazil U23","Brazil,BR");
        hm.put("Charlton U21","Charlton,GB");
        hm.put("Mohun Bagan SG","kolkata");
        hm.put("Mainz 05","Mainz");
        hm.put("EO Sidi Bouzid","Sidi Bouzid");
        hm.put("Sampdoria","Genoa");
        hm.put("Dunbar Rovers","Sydney");
        hm.put("Para Hills East","Adelaide");
        hm.put("Adelaide Hills","Adelaide");
        hm.put("Paris SG (W)","Paris");
        hm.put("AF Elbasani","Elbasan");
        hm.put("Hertha BSC U19","Berlin");
        hm.put("SU Sintrense","Sintra");
        hm.put("Spezia Youth","La Spezia");
        hm.put("Prison Leopards","Kabwe");
        hm.put("United of Manchester","Manchester");
        hm.put("BK Frem","Copenhagen");
        hm.put("Atromitos FC","Peristeri");
        hm.put("CD Lerinés","Lerin");
        hm.put("Fulham United","Adelaide");
        hm.put("AD Mérida","Mérida , ES");
        hm.put("Modbury Vista","Adelaide");
        hm.put("Carl Zeiss Jena ","Jena,DE");
        hm.put("H. Slavia Kromeriz","Kroměříž");
        hm.put("Angkor Tiger FC","Siem Reap");
        hm.put("Dessel Sport","Dessel,BE");
        hm.put("Tauro FC","Panama City , PA");
        hm.put("Assyriska FF","Stockholm");
        hm.put("Manchester 62 FC","Gibraltar");
        hm.put("Cardiff Met","Cardiff");
        hm.put("Marítimo","Funchal");
        hm.put("US Forces Armées","Ouagadougou");
        hm.put("Froya FK","Sistranda");
        ...
        hm.put("Khor SC","al Khor");
        hm.put("Kelty Hearts","Kelty");
        hm.put("Deportivo La Guaira","La Guaira");
        hm.put("Brave SC","Ocala");
        hm.put("FK Maktaaral","Shymkent");
        hm.put("1. SC Feucht","Feucht");
        hm.put("Al Bidda SC","Doha");
        hm.put("Stromsgodset IF","Oslo");
        hm.put("Ittifaq Maqaba","bahrain");
        hm.put("FC Süderelbe","Hamburg");
        hm.put("Leamington","Leamington spa");
        hm.put("Tormenta FC","Statesboro");
        ...
        hm.put("Real Sociedad","San Sebastian");
        hm.put("San Bartolomé CF","San Bartolomé");
        hm.put("CP San Cristóbal","San Cristóbal,ES");
        hm.put("UD Gran Tarajal ST","Tuineje");
        hm.put("Sevilla","Seville");
        hm.put("Pirata FC","Chiclayo");
        hm.put("Jeonbuk Hyundai M.","Jeonju");
        hm.put("FK Metta","Riga");
        hm.put("FC Mauerwerk","Wien");
        hm.put("Tindastóll (W)","Sauðárkrókur");
        hm.put("IF Lodde","Kävlinge");
        hm.put("Kjelsas","oslo");
        hm.put("Shkendija'79","Tetovo");
        hm.put("Fermana FC","Fermo");
        hm.put("Fylkir FC","Árbær");
        hm.put("Rasisalai United","Sisaket");
        hm.put("Real Mallorca","Palma de Mallorca");
        hm.put("Univ de Chile","Santiago");
        hm.put("Ilioupoli","Athens");
        hm.put("UD Lanzarote","Arrecife");
        hm.put("Llapi","Podujevo");
        hm.put("FC Vilafranca","Vilafranca del Penedès");
        hm.put("Greifswalder FC","Greifswald");
        hm.put("SD Ponferradina B","Ponferrada");
        hm.put("Montpellier HSC","Montpellier");
        hm.put("Afrique Football Élite","Bamako");
        hm.put("Al Adalah","HoFuF");
        hm.put("Falcon FC/SE","Barra dos Coqueiros, Sergipe");
        hm.put("FK Csikszereda","Miercurea Ciuc");
        hm.put("Maringá FC/PR","Maringá");
        hm.put("Fylkir (W)","reykjavik");
        hm.put("Costa Rica (W) U17","San jose,CR");
        hm.put("Godoy Cruz","Godoy Cruz,AR");
        hm.put("Humble Lions","May Pen");
        hm.put("Tivoli Gardens ","Kingston");
        hm.put("Podbeskidzie","Bielsko-Biała");
        hm.put("Sportivo Dock Sud","Dock Sud");
        hm.put("Sportivo Ameliano","Asuncion");
        hm.put("Ethnikos Achnas","Achna");
        hm.put("AS Roma","Roma,IT");
        hm.put("Estudiantes La Plata","La Plata");
        hm.put("Trabzonspor (W)","Trabzon");
        hm.put("Nottingham F. U21","Nottingham");
        hm.put("Al Jndal","Sakakah");
        hm.put("AC d'Escaldes","Andorra");
        ...
        hm.put("Leamington","Leamington,gb");
        hm.put("Stamford AFC","Stamford,gb");
        hm.put("CD Santa Úrsula","Seville");
        hm.put("Dalkeith Thistle FC","Dalkeith");
        hm.put("Bonnyrigg Rose","Seville");
        hm.put("Esteghlal Molasani","ahvaz");
        hm.put("Libya (W)","benghazi,ly,");
        hm.put("Pyunik FC","Yerevan");
        hm.put("FC Ararat-Armenia","Yerevan");
        hm.put("FC Nordsjælland","Farum");
        hm.put("Partick Thistle","glasgow");
        hm.put("Edinburgh Univ AFC","Edinburgh");
        hm.put("Golspie Sutherland","Golspie");
        hm.put("St Andrews United","Seville");
        hm.put("Istra 1961","pula");
        hm.put("Bibiani Gold Stars FC","Wiawso");
        hm.put("St. Gallen U21","St. Gallen,ch");
        hm.put("Lancaster City","Lancaster,gb");
        hm.put("Leyton Orient","Leyton,gb");
        hm.put("Charlton Athletic","Charlton,gb");
        hm.put("Carlisle United","Carlisle,gb");
        ...
        hm.put("Bem. Heath Harlequins","Salisbury,gb");
        hm.put("Badshot Lea FC","Wrecclesham");
        hm.put("Dulwich Hamlet","Dulwich,gb");
        hm.put("Canvey Island","Canvey Island,gb");
        hm.put("Beaconsfield Town","Beaconsfield,gb");
        hm.put("QPR","London");
        hm.put("Chicago Fire","Chicago");
        hm.put("Guadalajara Chivas","Guadalajara");
        hm.put("Wiener Viktoria","Wien");
        hm.put("Heybridge Swifts","Heybridge,gb");
        hm.put("ORBIT College FC","Rustenburg");
        hm.put("1928 Bucaspor","Buca");
        hm.put("FC Südtirol Youth","South Tyrol");
        hm.put("1. FC Düren","Düren");
        hm.put("Chennaiyin FC","Chennai");
        hm.put("Cremonese Youth","Cremona");
        hm.put("DC United","Washington Dc");
        hm.put("Memphis 901","Memphis");
        hm.put("Grazer AK","Graz");
        hm.put("Hapoel Tel Aviv","Tel Aviv");
        hm.put("Inverness CT","Inverness");
        ...
        hm.put("1. FC Heidenheim","Heidenheim");
        hm.put("Eintracht Fr. U19","Frankfurt");
        hm.put("Amasyaspor 1968 FK","Amasya");
        hm.put("PFK Kuban","Krasnodar");
        hm.put("Montrose FC (W)","Seville");
        hm.put("Monopoli Youth","Bari");
        hm.put("Sokol Zivanice","Pardubice");
        hm.put("Panthrakikos","Komotini");
        hm.put("FK Biolog","Novokubansk");
        hm.put("Lobos UPNFM","Tegucigalpa");
        hm.put("Ionikos","Nikaia");
        hm.put("Cobreloa","Calama");
        hm.put("KS Burreli","Burrel");
        hm.put("Wuxi Wugo","Wuxi");
        hm.put("Slovacko B","Uherské Hradiště");
        hm.put("Sint-Eloois-Winkel Sport","Sint-Eloois-Winkel");
        hm.put("ŁKS II Łódź","Łódź");
        hm.put("SU 1º Dezembro","Sintra");
        hm.put("Pécsi MFC","Pécs");
        hm.put("Santiago Morning","Santiago,CL");
        hm.put("Ulinzi Stars","Nakuru");
        hm.put("Torns IF","Lund");
        hm.put("Harborough Town FC","Northampton,gb");
        hm.put("Nouakchott King's","Nouakchott");
        hm.put("FC Südtirol","South Tyrol");
        hm.put("AIK Fotboll","Stockholm");
        hm.put("FK FK Yenisey (W)","Krasnoyarsk");
        hm.put("FK Yenisey","Krasnoyarsk");
        hm.put("FK Yenisey-2","Krasnoyarsk");
        hm.put("Galatasaray SK (W)","Istanbul");
        hm.put("Fatih Karagümrük","Istanbul");
        hm.put("Strommen IF","Strømmen");
        hm.put("Karlbergs BK","Stockholm");
        hm.put("Inter Türkspor Kiel","Kiel");
        hm.put("IK Sleipner","Norrköping");
        hm.put("CD Mirandés","Ebro");
        hm.put("Östers IF","Växjö");
        hm.put("Budaörsi SC (W)","Budaörs");
        hm.put("FC Uni Minsk","Minsk");
        hm.put("Augnablik (W)","Kópavogur");
        hm.put("Augnablik","Kópavogur");
        hm.put("Ihud Bnei Shfaram","Nazareth");
        hm.put("Deportivo Fabril","A Coruna");
        hm.put("KJP","Kouvola");
        hm.put("Cuniburo FC","Quito");
        hm.put("Al Nassr Riyadh","Riyadh");
        hm.put("Al Nassr Riyadh (W)","Riyadh");
        hm.put("Gaadiidka FC","Mogodishu");
        hm.put("FC Kiisto Vaasa","Vaasa");
        hm.put("Maccabi Tel Aviv","Tel Aviv");
        hm.put("VMFD Zalgiris","Vilnius");
        hm.put("Lillestrom Youth","Lillestrom");
        hm.put("Maccabi Kabilio Jaffa","Jaffa");
        hm.put("FC Finnkurd","Helsinki");
        hm.put("Ramtha Club","Irbid");
        hm.put("Houston Dynamo","Houston");
        hm.put("Ludogorets","Razgrad");
        hm.put("Persepolis FC","Tehran");
        hm.put("Stromsgodset IF Youth","Oslo");
        hm.put("CD Águila","San Miguel, El Salvador");
        hm.put("Gjilani","Gjilan");
        hm.put("Kristianstads FC","Kristianstad");
        hm.put("FC Honka/2","Espoo");
        hm.put("Cork City","Cork,IE");
        hm.put("Valmieras FK","Valmiera");
        hm.put("Jarun","Zagreb");
        hm.put("Ludogorets II","Razgrad");
        hm.put("Sepsi OSK","Sfântu Gheorghe");
        hm.put("FC Andranik","VARdenis");
        hm.put("Flandria","Jáuregui");
        hm.put("Stjarnan FC","iceland");
        hm.put("Portland Thorns (W)","Portland");
        hm.put("QPR U21","London");
        hm.put("Seattle Sounders","Seattle");
        hm.put("Ji'nan Xingzhou","Jinan");
        hm.put("Visakha FC","Phnom Penh");
        hm.put("FK Zorka-BDU (W)","Minsk");
        hm.put("FK Zorka-BDU","Minsk");
        hm.put("Slovacko (W)","Uherské Hradiště");
        hm.put("Kasetsart FC","Bangkok");
        hm.put("FK Osipovichi","Asipovichy");
        hm.put("FC Lahti (W)","Lahti,FI");
        hm.put("Balestier Khalsa","Toa Payoh");
        hm.put("1. FC Kleve 63/03","Kleve");
        hm.put("Inter Turku/2","Turku");
        hm.put("AS Otôho","Cuvette");
        hm.put("Emirates Club U21","Dubai");
        hm.put("Ballkani","Suva Reka");
        hm.put("Sandvikens IF","Sandviken");
        hm.put("FK Riteriai-2","Vilnius");
        hm.put("FK Riteriai","Vilnius");
        hm.put("Cobán Imperial","Cobán");
        hm.put("Tranmere Rovers","Birkenhead,GB");
        ...
        hm.put("União de Tomar","Tomar");
        hm.put("Drita FC","Gjilan");
        hm.put("Grankulla IFK","Kauniainen");
        hm.put("Haladas","Szombathely");
        hm.put("Sarpsborg 08 2","Sarpsborg");
        hm.put("Acacia Ridge","Acacia Ridge");
        hm.put("East Timor U23","Dili");
        hm.put("East Timor","Dili");
        hm.put("IPS Edustus","Imatra");
        hm.put("FF Jaro","Jakobstad");
        hm.put("Strumska Slava","Radomir");
        hm.put("Nardo FK","Trondheim");
        hm.put("Strommen IF","Lillestrøm");
        hm.put("Skedsmo FK","Lillestrøm");
        hm.put("Adana Demirspor","Adana");
        hm.put("Trables SC","Tripoli,lb");
        hm.put("CS Fola Esch","Esch-sur-Alzette");
        hm.put("Mulheimer FC 97","Mülheim an der Ruhr");
        hm.put("Al Ahed Beirut","Beirut");
        hm.put("TUS Makkabi Berlin","Berlin");
        hm.put("Inter Türkspor Kiel","Kiel");
        hm.put("Darul Takzim","Johor Bahru");
        hm.put("Civil Service","Lilongwe");
        hm.put("SV Rugenbergen","Bönningstedt");
        hm.put("Halstenbek-Rellingen","Halstenbek");
        hm.put("Skövde AIK U21","Skövde");
        hm.put("Machhindra FC","Kathmandu");
        ...
        hm.put("Tigres UANL","Monterrey");
        hm.put("Canberra Croatia","Canberra");
        hm.put("Nautico/PE","Recife");
        hm.put("Dundalk FC","Dundalk,IE");
        hm.put("Atlético El Vigía","El Vigía");
        hm.put("La Equidad","Bogotá");
        hm.put("B1 FC","St. Lucia");
        hm.put("CD Marathón","San Pedro Sula");
        hm.put("Puerto Cabello","Puerto Cabello");
        hm.put("Houston Dynamo 2","Houston");
        hm.put("Houston Dynamo","Houston");
        hm.put("Nadroga FC","Sigatoka");
        hm.put("CCM Academy","Gosford");
        hm.put("Stromsgodset 2","Oslo");
        hm.put("Stromsgodset","Oslo");
        hm.put("Bavarians FC","Ulaanbaatar");
        hm.put("Udinese Youth","Udine");
        hm.put("Army FC","Phnom Penh");
        hm.put("Kocaelispor","Kocaeli");
        hm.put("Schalke 04","Gelsenkirchen");
        hm.put("Salernitana","Salerno");
        hm.put("Cultural Leonesa","Leon,Es");
        hm.put("SD Logroñés","Logroño");
        hm.put("Binacional","Juliaca");
        hm.put("Cobán Imperial","Cobán");
        hm.put("South East FC","Dominica");
        hm.put("Cerro Porteño","Asunción");
        hm.put("Grêmio Prudente/SP","Sao Paolo");
        hm.put("CD Huachipato","Talcahuano");
        hm.put("Artsul FC/RJ","Nova Iguaçu");
        hm.put("FK Beitar","Riga");
        hm.put("Ba FC","fiji");
        hm.put("Kochi United SC","Kochi,JP");
        hm.put("Pyeongchang United","Wonju");
        hm.put("FC Arlanda","marsta");
        hm.put("KF Teuta Durres","Durres");
        hm.put("Balatonfuredi FC","Balatonfured");
        hm.put("Budapesti VSC","Budapest");
        hm.put("FC Honka Espoo","Espoo");
        hm.put("Bonner SC","Bonn,de");
        hm.put("VPV","Helsinki");
        ...
        hm.put("Volos NFC","Volos");
        hm.put("FK Metalac","Gornji Milanovac");
        hm.put("Jönköpings S. U21","Jönköping");
        hm.put("Burkina Faso U20","Burkina Faso");
        hm.put("Burkina Faso","Burkina Faso");
        hm.put("CFC Hertha 06","Berlin");
        hm.put("Qingdao Red Lions","Qingdao");
        hm.put("JEF United Chiba","Chiba");
        hm.put("Notts County (W)","Nottingham");
        hm.put("Notts County","Nottingham");
        hm.put("SK Djerv 1919","Haugesund");
        hm.put("FC Futura","Porvoo");
        hm.put("Highlanders FC","Bulawayo");
        ...
        hm.put("Asane Fotball","Bergen");
        hm.put("Aral Samali","Nukus");
        hm.put("Stabaek 2","Bærum");
        hm.put("Stabaek 2","oslo");
