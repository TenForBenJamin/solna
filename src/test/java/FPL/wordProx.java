...
public class wordProx extends parama {
    ...
    public static String southendReplacement(String clubName){
        ...
        String originalKeyName=null;
            //                                     hm.put("Tokushima Vortis","Tokushima Vortis");
            String paola=null;
        hm.put("Rio Ave U23","Vila do Conde");
        hm.put("Shakhtar D. Youth","Donetsk");
        hm.put("Mexico (W) U20","Mexico,MX");
        hm.put("Team Thoren","Umeå");
        hm.put("Myawady FC","Naypyidaw");
        hm.put("SoCal Seahorses","La Mirada, California");
        hm.put("Real Salt Lake","Salt Lake");
        hm.put("FC Shukura","Kobuleti");
        hm.put("Augnablik","Kópavogur")
        ;hm.put("Viettel FC","Hanoi");
        hm.put("FC Südtirol","South Tyrol,IT");
        hm.put("Always Ready","El Alto");
        hm.put("IK Oddevold","Uddevalla");
        hm.put("FK Bodo/Glimt","Bodo");
        hm.put("Chapecoense/SC","Chapecó");
        hm.put("Tavua FC","NADI,FJ");
        hm.put("Colon Santa Fe","Colon Santa Fe");
        hm.put("Mexico U20","Mexico,MX");
        hm.put("Mexico","Mexico,MX");
        hm.put("RSV Eintracht 1949","Stahnsdorf");
        hm.put("Miedz II Legnica","Legnica");
        hm.put("Western Pride","Ipswich,AU");
        ...
        hm.put("Brunei DPMM FC","Brunei");
        hm.put("Tokushima Vortis","Tokushima");
        hm.put("Tokyo Verdy","Tokyo");
        ...
        hm.put("Stenungsunds IF","Stenungsund");
        hm.put("Volda TI","Volda");
        hm.put("Rewa FC","Nausori");
        hm.put("Mathare United","Nairobi");
        hm.put("SC Freiburg (W)","Freiburg,DE");
        hm.put("SC Freiburg","Freiburg,DE");
        hm.put("Husqvarna FF","Jönköping");
        hm.put("Pogon II Szczecin","Szczecin");
        hm.put("Meizhou Hakka","Meizhou");
        hm.put("Ferencvaros TC (W)","Budapest");
        hm.put("Ferencvaros TC","Budapest");
        hm.put("Moreton Bay Utd","Moreton Bay,AU");
        hm.put("Hallescher FC","Halle");
        ...
        hm.put("Sunshine Coast Wanderers","Sunshine Coast");
        ...
        hm.put("FC Ararat-Armenia","Yereven");
        ...
        hm.put("Catalcaspor","Catalca");
        hm.put("Edirnespor","Edirne");
        hm.put("Kutahyaspor","Kutahya");
        ...
        hm.put("Bohemians FC","Dublin,IE");
        hm.put("UCD Dublin","Dublin,IE");
        ...
        hm.put("Sporting de Macau","Macau");
        hm.put("Naestved HG (W)","Naestved");
        hm.put("Mount Gravatt","Mount Gravatt");
        hm.put("FC Midtjylland","Herning");
        hm.put("Slovacko U19","Uherské Hradiště");
        ...
        hm.put("Binh Thuan FC","Phan Thiết");
        ...
        hm.put("Vélez Sársfield","Liniers");
        ...
        hm.put("Strindheim TF","Trondheim");
        hm.put("Kolstad Fotball","Trondheim");
        ...
        hm.put("Viking FK 2","Stavanger");
        hm.put("Rapid Bucuresti","Bucharest");
        hm.put("FC Südtirol","Tirol,it");
        hm.put("CD Numancia","Soria,ES");
        hm.put("SønderjyskE","Haderslev,DK");
        hm.put("Bnei Yehuda","Bnei Yehuda");
        hm.put("Hapoel Umm Al Fahm","Haifa");
